...
public class SeedDaNangPois {
  ...
  private static PlaceDoc poiMyKhe() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Top bãi biển châu Á").slug("top-bai-bien-chau-a").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thể thao nước").slug("the-thao-nuoc").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc poiBaNaHills() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Khu du lịch nghỉ dưỡng").slug("khu-du-lich-nghi-duong").build(),
            PlaceDoc.CategoryMini.builder().name("Giải trí").slug("giai-tri").build(),
            PlaceDoc.CategoryMini.builder().name("Thiên nhiên").slug("thien-nhien").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Cầu Vàng biểu tượng").slug("cau-vang-bieu-tuong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Cáp treo").slug("cap-treo").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiNguHanhSon() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            ...
            PlaceDoc.CategoryMini.builder().name("Thiên nhiên").slug("thien-nhien").build(),
            PlaceDoc.CategoryMini.builder().name("Công trình tôn giáo").slug("cong-giao").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Ngũ Hành Sơn").slug("ngu-hanh-son").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Làng nghề thủ công").slug("lang-nghe-thu-cong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiCauRong() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Phun lửa cuối tuần").slug("phun-lua-cuoi-tuan").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Đời sống về đêm").slug("doi-song-ve-dem").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  ...
  private static PlaceDoc poiSonTra() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Đỉnh Bàn Cờ săn mây").slug("dinh-ban-co-san-may").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Bảo tồn thiên nhiên").slug("bao-ton-thien-nhien").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  ...
  private static PlaceDoc poiChoHan() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Chợ & Mua sắm").slug("cho-va-mua-sam").build(),
            PlaceDoc.CategoryMini.builder().name("Ẩm thực").slug("am-thuc").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Đặc sản Đà Nẵng").slug("dac-san-da-nang").type(TagType.CUISINE).build(),
            PlaceDoc.TagMini.builder().name("Chợ địa phương").slug("cho-dia-phuong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc poiAsiaPark() {
    ...
    return PlaceDoc.builder()
        ...
        .atmosphere("urban-entertainment")
        .travelStyle(List.of("casual", "exploration"))
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Vòng quay Sun Wheel").slug("vong-quay-sun-wheel").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Đời sống về đêm").slug("doi-song-ve-dem").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiBaoTangCham() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Bảo tàng").slug("bao-tang").build(),
            PlaceDoc.CategoryMini.builder().name("Di tích lịch sử").slug("di-tich-lich-su").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Bảo tàng Chăm").slug("bao-tang-cham").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Giáo dục lịch sử").slug("giao-duc-lich-su").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Tham quan có hướng dẫn").slug("tham-quan-co-huong-dan").type(TagType.SERVICE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  }
