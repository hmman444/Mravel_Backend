...
public class SeedSaPaPois {
  ...
  private static PlaceDoc poiFansipan() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Đỉnh núi & Chinh phục").slug("dinh-nui-chinh-phuc").build(),
            PlaceDoc.CategoryMini.builder().name("Biểu tượng vùng miền").slug("bieu-tuong-vung-mien").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Nóc nhà Đông Dương").slug("noc-nha-dong-duong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Biển mây Hoàng Liên").slug("bien-may-hoang-lien").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Cáp treo Fansipan").slug("cap-treo-fansipan").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiBanCatCat() {
    ...
    return PlaceDoc.builder()
       ...
       .content(List.of(
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Bản làng dân tộc").slug("ban-lang-dan-toc").build(),
            PlaceDoc.CategoryMini.builder().name("Văn hóa & Thủ công").slug("van-hoa-thu-cong").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Bản Mông Cát Cát").slug("ban-mong-cat-cat").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Guồng nước thung lũng").slug("guong-nuoc-thung-lung").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc poiBanTaPhin() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Người Dao đỏ Tả Phìn").slug("nguoi-dao-do-ta-phin").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Tắm lá thuốc").slug("tam-la-thuoc").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Tu viện cổ rêu phong").slug("tu-vien-co-reu-phong").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  }
  ...
  private static PlaceDoc poiDeoOQuyHo() {
    ...
    return PlaceDoc.builder()
       ...
       .content(List.of(
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Đèo núi & Cung đường").slug("deo-nui-cung-duong").build(),
            PlaceDoc.CategoryMini.builder().name("Cảnh quan thiên nhiên").slug("canh-quan-thien-nhien").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Tứ đại đỉnh đèo").slug("tu-dai-dinh-deo").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Biển mây Hoàng Liên").slug("bien-may-hoang-lien").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Cổng Trời Ô Quy Hồ").slug("cong-troi-o-quy-ho").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiThacBac() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Thác bạc Sa Pa").slug("thac-bac-sa-pa").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Bậc gỗ leo thác").slug("bac-go-leo-thac").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc poiThacTinhYeu() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Lăng mạn giữa rừng").slug("lang-man-giua-rung").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Rừng quốc gia Hoàng Liên").slug("rung-quoc-gia-hoang-lien").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Ghềnh Vàng Suối Vàng").slug("ghenh-vang-suoi-vang").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  }
  ...
  private static PlaceDoc poiNhaThoDaSaPa() {
    ...
    return PlaceDoc.builder()
        ...
        .atmosphere("town-square-heritage")
        .travelStyle(List.of("casual", "photography", "exploration"))
        .suitableFor(List.of("solo", "couple", "family", "group"))
        .visitPurpose(List.of("culture", "photography", "explore"))
        .crowdLevel(CrowdLevel.HIGH)
        ...
        .categories(List.of(
            ...
            PlaceDoc.CategoryMini.builder().name("Biểu tượng thị trấn").slug("bieu-tuong-thi-tran").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Nhà thờ đá cổ kính").slug("nha-tho-da-co-kinh").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Chợ phiên cuối tuần").slug("cho-phien-cuoi-tuan").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Quảng trường trung tâm").slug("quang-truong-trung-tam").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  }
