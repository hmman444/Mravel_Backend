...
public class SeedNhaTrangPois {
  ...
  private static PlaceDoc poiThapTramHuong() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Biểu tượng thành phố").slug("bieu-tuong-thanh-pho").build(),
            PlaceDoc.CategoryMini.builder().name("Quảng trường").slug("quang-truong").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng Nha Trang").slug("bieu-tuong-nha-trang").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Check-in biển").slug("check-in-bien").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiChuaLongSon() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Công trình tôn giáo").slug("cong-trinh-ton-giao").build(),
            PlaceDoc.CategoryMini.builder().name("Di tích lịch sử").slug("di-tich-lich-su").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Tượng Phật Trắng").slug("tuong-phat-trang").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("View toàn cảnh Nha Trang").slug("view-toan-canh-nha-trang").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  ...
  private static PlaceDoc poiBaiDaiCamRanh() {
    ...
    return PlaceDoc.builder()
        .active(true)
        .kind(PlaceKind.POI)
        .name("Đường chân trời Bãi Dài (Cam Ranh)")
        .slug(slug)
        .parentSlug("nha-trang")
        .ancestors(List.of("nha-trang"))
        .childrenCount(0)
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Bãi biển").slug("bai-bien").build(),
            PlaceDoc.CategoryMini.builder().name("Thiên nhiên").slug("thien-nhien").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Bãi Dài Cát Mịn").slug("bai-dai-cat-min").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Vịnh Cam Ranh").slug("vinh-cam-ranh").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  ...
  private static PlaceDoc poiDocLet() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biển Nông An Toàn").slug("bien-nong-an-toan").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Hàng Dương Râm Mát").slug("hang-duong-ram-mat").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  }
  ...
  private static PlaceDoc poiDiepSon() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Bãi biển & Đảo").slug("bai-bien-dao").build(),
            PlaceDoc.CategoryMini.builder().name("Thiên nhiên").slug("thien-nhien").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Con đường trên biển").slug("con-duong-tren-bien").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Vịnh Vân Phong").slug("vinh-van-phong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Phụ thuộc thủy triều").slug("phu-thuoc-thuy-trieu").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiBaHoWaterfalls() {
    ...
    return PlaceDoc.builder()
        ...
        .vibes(List.of("nature", "peaceful", "adventurous"))
        .atmosphere("rainforest-waterfall")
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Thiên nhiên").slug("thien-nhien").build(),
            PlaceDoc.CategoryMini.builder().name("Thác nước & Suối").slug("thac-nuoc-suoi").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Trekking nhẹ").slug("trekking-nhe").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Tắm suối mát").slug("tam-suoi-mat").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc poiHonKhoiSaltField() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Cảnh quan lao động").slug("canh-quan-lao-dong").build(),
            PlaceDoc.CategoryMini.builder().name("Thiên nhiên").slug("thien-nhien").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Đồng muối bình minh").slug("dong-muoi-binh-minh").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Chụp ảnh lao động").slug("chup-anh-lao-dong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Phản chiếu mặt nước").slug("phan-chieu-mat-nuoc").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  }
  ...
  private static PlaceDoc poiNinhVanBay() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Nghỉ dưỡng cao cấp").slug("nghi-duong-cao-cap").build(),
            PlaceDoc.CategoryMini.builder().name("Bãi biển & Đảo").slug("bai-bien-dao").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Vịnh tĩnh lặng").slug("vinh-tinh-lang").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Trốn phố").slug("tron-pho").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Không gian riêng tư").slug("khong-gian-rieng-tu").type(TagType.FEATURE).build()
        ))
