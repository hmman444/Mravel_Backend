...
public class SeedDestinations {
  ...
  private static PlaceDoc daNang() {
    ...
    return PlaceDoc.builder()
        ...
        .openHours(List.of())
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Điểm đến biển").slug("diem-den-bien").build(),
            PlaceDoc.CategoryMini.builder().name("Thành phố").slug("thanh-pho").build(),
            PlaceDoc.CategoryMini.builder().name("Ẩm thực").slug("am-thuc").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Cầu Rồng – Cầu Vàng").slug("cau-rong-cau-vang").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Bãi biển Mỹ Khê").slug("bai-bien-my-khe").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc hoiAn() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Di sản văn hoá").slug("di-san-van-hoa").build(),
  ...
  private static PlaceDoc haNoi() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Thủ đô").slug("thu-do").build(),
            PlaceDoc.CategoryMini.builder().name("Di tích lịch sử").slug("di-tich-lich-su").build(),
            PlaceDoc.CategoryMini.builder().name("Ẩm thực").slug("am-thuc").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Phố cổ 36 phố phường").slug("pho-co-36-pho-phuong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Hồ Hoàn Kiếm").slug("ho-hoan-kiem").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc hoChiMinh() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Đô thị").slug("do-thi").build(),
            PlaceDoc.CategoryMini.builder().name("Ẩm thực").slug("am-thuc").build(),
            PlaceDoc.CategoryMini.builder().name("Di tích lịch sử").slug("di-tich-lich-su").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Nhà thờ Đức Bà").slug("nha-tho-duc-ba").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Ẩm thực đường phố").slug("am-thuc-duong-pho").type(TagType.CUISINE).build(),
            PlaceDoc.TagMini.builder().name("Thành phố không ngủ").slug("thanh-pho-khong-ngu").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  }
  ...
  private static PlaceDoc sapa() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Miền núi & Cao nguyên").slug("mien-nui-cao-nguyen").build(),
            PlaceDoc.CategoryMini.builder().name("Dân tộc thiểu số").slug("dan-toc-thieu-so").build(),
            PlaceDoc.CategoryMini.builder().name("Trekking").slug("trekking").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Ruộng bậc thang").slug("ruong-bac-thang").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Fansipan").slug("fansipan").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc nhaTrang() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            ...
            PlaceDoc.TagMini.builder().name("Tháp Bà Ponagar").slug("thap-ba-ponagar").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
