...
public class SeedHoChiMinhPois {
  ...
  private static PlaceDoc poiNhaThoDucBa() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng thành phố").slug("bieu-tuong-thanh-pho").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc poiBuuDienTrungTam() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng thành phố").slug("bieu-tuong-thanh-pho").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Trong nhà").slug("trong-nha").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  }
  ...
  private static PlaceDoc poiPhoDiBoNguyenHue() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Phố đi bộ").slug("pho-di-bo").build(),
  ...
  private static PlaceDoc poiBaoTangChungTichChienTranh() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Giáo dục lịch sử").slug("giao-duc-lich-su").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Trưng bày ảnh tư liệu").slug("trung-bay-anh-tu-lieu").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  }
  ...
  private static PlaceDoc poiNhaHatThanhPho() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng thành phố").slug("bieu-tuong-thanh-pho").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Nghệ thuật biểu diễn").slug("nghe-thuat-bieu-dien").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  }
  ...
  private static PlaceDoc poiBitexcoSkydeck() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Đài quan sát").slug("dai-quan-sat").build(),
            PlaceDoc.CategoryMini.builder().name("Kiến trúc").slug("kien-truc").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Tầm nhìn toàn cảnh").slug("tam-nhin-toan-canh").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Trong nhà").slug("trong-nha").type(TagType.FEATURE).build()
        ))
