...
public class SeedHoiAnPois {
  ...
  private static PlaceDoc poiChuaCau() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            ...
            PlaceDoc.CategoryMini.builder().name("Kiến trúc").slug("kien-truc").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng Hội An").slug("bieu-tuong-hoi-an").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Chùa Cầu Nhật Bản").slug("chua-cau-nhat-ban").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc poiPhoCoHoiAn() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Phố cổ").slug("pho-co").build(),
            PlaceDoc.CategoryMini.builder().name("Văn hoá").slug("van-hoa").build(),
            PlaceDoc.CategoryMini.builder().name("Ẩm thực").slug("am-thuc").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Di sản UNESCO").slug("di-san-unesco").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Đèn lồng Hội An").slug("den-long-hoi-an").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc poiSongHoaiThuyenDenLong() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Sông & Bến").slug("song-ben").build(),
            PlaceDoc.CategoryMini.builder().name("Văn hoá").slug("van-hoa").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Thả hoa đăng").slug("tha-hoa-dang").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Đèn lồng phố Hội").slug("den-long-pho-hoi").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Lãng mạn").slug("lang-man").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  }
  ...
  private static PlaceDoc poiBienAnBang() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biển bình yên").slug("bien-binh-yen").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Ngắm hoàng hôn").slug("ngam-hoang-hon").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiCuLaoCham() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Khu dự trữ sinh quyển").slug("khu-du-tru-sinh-quyen").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Lặn ngắm san hô").slug("lan-ngam-san-ho").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiLangGomThanhHa() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Làng nghề thủ công").slug("lang-nghe-thu-cong").build(),
            PlaceDoc.CategoryMini.builder().name("Văn hoá").slug("van-hoa").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Gốm đất nung").slug("gom-dat-nung").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Nặn gốm thủ công").slug("nan-gom-thu-cong").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc poiLangRauTraQue() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Làng nông nghiệp").slug("lang-nong-nghiep").build(),
            PlaceDoc.CategoryMini.builder().name("Ẩm thực").slug("am-thuc").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Rau sạch Trà Quế").slug("rau-sach-tra-que").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Lớp học nấu ăn").slug("lop-hoc-nau-an").type(TagType.SERVICE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
  ...
  private static PlaceDoc poiNhaCoTanKy() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Nhà cổ").slug("nha-co").build(),
            PlaceDoc.CategoryMini.builder().name("Kiến trúc").slug("kien-truc").build(),
            PlaceDoc.CategoryMini.builder().name("Di tích lịch sử").slug("di-tich-lich-su").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Hơn 200 năm tuổi").slug("hon-200-nam-tuoi").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Kiến trúc Hoa – Nhật – Việt").slug("kien-truc-hoa-nhat-viet").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
