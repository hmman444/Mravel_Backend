...
public class SeedHaNoiPois {
  ...
  private static PlaceDoc poiHoHoanKiem() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            ...
            PlaceDoc.CategoryMini.builder().name("Thiên nhiên & Hồ").slug("thien-nhien-ho").build(),
            PlaceDoc.CategoryMini.builder().name("Công trình tôn giáo").slug("cong-giao").build()
        ))
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng thủ đô").slug("bieu-tuong-thu-do").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Phố đi bộ").slug("pho-di-bo").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc poiPhoCoHaNoi() {
    ...
    return PlaceDoc.builder()
        ...
        .categories(List.of(
            PlaceDoc.CategoryMini.builder().name("Phố cổ & Mua sắm").slug("pho-co-mua-sam").build(),
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("36 phố phường").slug("36-pho-phuong").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc poiLangChuTichHoChiMinh() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Di sản quốc gia").slug("di-san-quoc-gia").type(TagType.FEATURE).build(),
  ...
  private static PlaceDoc poiVanMieuQuocTuGiam() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng hiếu học").slug("bieu-tuong-hieu-hoc").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Di sản quốc gia").slug("di-san-quoc-gia").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
  ...
  private static PlaceDoc poiHoTayTranQuoc() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            ...
            PlaceDoc.TagMini.builder().name("Đạp xe ven hồ").slug("dap-xe-ven-ho").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  ...
  private static PlaceDoc poiCauLongBien() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            PlaceDoc.TagMini.builder().name("Biểu tượng thủ đô").slug("bieu-tuong-thu-do").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Nhiếp ảnh").slug("nhiep-anh").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.FREE)
        .build();
  ...
  private static PlaceDoc poiHoangThanhThangLong() {
    ...
    return PlaceDoc.builder()
        ...
        .tags(List.of(
            ...
            PlaceDoc.TagMini.builder().name("Khảo cổ").slug("khao-co").type(TagType.FEATURE).build(),
            PlaceDoc.TagMini.builder().name("Thân thiện gia đình").slug("than-thien-gia-dinh").type(TagType.FEATURE).build()
        ))
        .priceLevel(PriceLevel.CHEAP)
        .build();
